setwd("/omics/groups/OE0246/internal/guz/cola_hc/examples/NestorowaHSC")
library(cola)
...
library(scRNAseq)
data = readRDS('/omics/groups/OE0246/internal/guz/cola_hc/examples/NestorowaHSC/NestorowaHSC_data.rds')
